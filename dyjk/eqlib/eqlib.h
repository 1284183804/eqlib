...
EQLIB_API int jhq_set_num_bands(eqlib_handle* h, int n);
EQLIB_API int jhq_get_num_bands(eqlib_handle* h, int* out);
...
EQLIB_API int jhq_set_band_freqs(eqlib_handle* h, const double* freqs_hz, int n);
