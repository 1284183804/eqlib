...
class EQLIB_INTERNAL AutoEqCore {
    ...
    double m_reference_gains_db[AUTO_EQ_MAX_POINTS]{};
    double m_reference_freqs_hz[AUTO_EQ_MAX_POINTS]{};
    int    m_reference_points{0};
    bool   m_reference_set{false};

    double m_measured_db[AUTO_EQ_MAX_POINTS]{};
    double m_measured_freqs_hz[AUTO_EQ_MAX_POINTS]{};
